...
export default function Articles() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E1A] text-white">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredArticles.map((article, i) => (
              <motion.article
                ...
                className="group bg-[#0F1629] rounded-2xl border border-[#1E2A45] p-6 hover:border-cyan-500/30 transition-all cursor-pointer"
      ...
      <section className="py-16 bg-[#080C18] border-t border-[#1E2A45]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <button className="px-6 py-3 bg-[#0F1629] border border-[#1E2A45] text-slate-400 rounded-xl hover:border-cyan-500/50 hover:text-cyan-400 transition-all">
            Submit Article
          </button>
        </div>
      </section>
